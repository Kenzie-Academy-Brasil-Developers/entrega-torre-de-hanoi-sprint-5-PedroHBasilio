...
jogarFacil.addEventListener("click", () => {
    ...
    selecionado = null
    jogarFacil.classList.add("jogarAtivo")
    jogarMedio.classList.remove("jogarAtivo")
    jogarDificil.classList.remove("jogarAtivo")
    
})

jogarMedio.addEventListener("click", () => {
    selecionado = null
    jogarFacil.classList.remove("jogarAtivo")
    jogarMedio.classList.add("jogarAtivo")
    jogarDificil.classList.remove("jogarAtivo")
})
...
jogarDificil.addEventListener("click", () => {
    ...
    jogarFacil.classList.remove("jogarAtivo")
    jogarMedio.classList.remove("jogarAtivo")
    jogarDificil.classList.add("jogarAtivo")
})
